...
var Mumbai = /*#__PURE__*/function (_NativeCurrency) {
  _inheritsLoose(Mumbai, _NativeCurrency);

  function Mumbai(chainId) {
    return _NativeCurrency.call(this, chainId, 18, 'matic', 'mumbai') || this;
  }

  Mumbai.onChain = function onChain(chainId) {
    var _this$_cache$chainId;

    return (_this$_cache$chainId = this._cache[chainId]) != null ? _this$_cache$chainId : this._cache[chainId] = new Mumbai(chainId);
  };

  var _proto = Mumbai.prototype;
